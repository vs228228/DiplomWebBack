...
{
    public class GetProjectManagersQueryHandler : IRequestHandler<GetProjectManagersQuery, IEnumerable<UserProjectResponseDto>>
    {
        private readonly IUserVerificationService _userVerificationService;
        private readonly IProjectRepository _projectRepository;

        public GetProjectManagersQueryHandler(IUserVerificationService userVerificationService, IProjectRepository projectRepository)
        {
            _projectRepository = projectRepository;
            _userVerificationService = userVerificationService;
        }

        public async Task<IEnumerable<UserProjectResponseDto>> Handle(GetProjectManagersQuery request, CancellationToken cancellationToken)
        {
            ...
            var users = await _projectRepository.GetManagersAsync(request.ProjectId, cancellationToken);

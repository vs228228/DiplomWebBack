...
namespace DiplomWebBack.Api.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpGet("me/skills")]
        public async Task<ActionResult<SkillExtraction>> GetMySkillsAsync(CancellationToken ct)
        {
            var userId = HttpContext.GetCurrentUserId();
        ...
        /// <summary>
        /// Добавитть скилл юзеру(если скилл с таким именем есть, то не добавит ничего)
        /// </summary>
        /// <param name="request"></param>
        /// <param name="ct"></param>
        /// <returns></returns>
        [HttpPost("me/skills")]
        public async Task<ActionResult> AddUserSkillAsync([FromBody] AddUserSkillRequestDto request, CancellationToken ct)
        {
            var userId = HttpContext.GetCurrentUserId();

            var command = new AddUserSkillCommand(userId, request);
        ...
        /// <summary>
        /// Удалить скилл текущего юзера
        /// </summary>
        /// <param name="SkillId"></param>
        /// <param name="ct"></param>
        /// <returns></returns>
        [HttpDelete("me/skills")]
        public async Task<ActionResult> DeleteUserSkillAsync([FromQuery] Guid SkillId, CancellationToken ct)
        {
            var userId = HttpContext.GetCurrentUserId();

...
namespace DiplomWebBack.DomainRepos.Repos
{
    public interface ITagsRepository : IBaseRepository<Tag>
    {
        ...
        Task<List<Tag>> GetByIdsAsync(IEnumerable<Guid> ids, CancellationToken cancellationToken, bool trackChanges = false);
        Task RemoveProjectTagsAsync(Guid projectId);
    }
}
